...
const About = () => {
  ...
  return (
    ...
    >
      <Card className="p-8 md:p-12 bg-gradient-to-br from-white to-secondary/30 shadow-xl card-modern border-0">
        <div className="relative">
          <div className="absolute -top-4 -left-4 w-20 h-20 bg-primary/10 rounded-full blur-2xl"></div>
          <h2 className="text-3xl font-bold mb-6 bg-gradient-to-r from-primary to-pink-400 bg-clip-text text-transparent relative z-10">
            Tentang SAMARA
          </h2>
